...
export function Mainverify() {
    ...
    const verifyMain = "https://celetelassets.s3.ap-south-1.amazonaws.com/gif/Flow+21%403x-50fps.gif"
    return (
        <Fragment>
            <div className="main_sol_page_verify">
                ...
                <p>Boost application security with scalable multi-factor authentication solutions designed for optimal conversion rates, all accessible via a unified API!.</p>
                <div className="btn2">
            ...
            <div className="main_sol_page9">
                <h1>Enhance security while maintaining continuous engagement.</h1>
                <p>
                    Boost application security with scalable multi-factor authentication solutions designed for optimal conversion rates, all accessible via a unified API!.
                </p>
                        ...
                        <div className="sub_container">
                            ...
                            <div className="sub_ver2">
                                ...
                                <span>
                                    ...
                                    processes run smoothly. We're here to assist you at every step.
                                </span>
                            </div>
                            <div className="sub_ver2">
                                <p>
